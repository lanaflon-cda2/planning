...
public class AjouterMat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 114, 36));
        getContentPane().add(matierefield, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 70, 200, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(!nommat.equals("")) {
            ...
            if(p == JOptionPane.YES_OPTION){
                ...
                Matiere mat = new Matiere(1,nommat);

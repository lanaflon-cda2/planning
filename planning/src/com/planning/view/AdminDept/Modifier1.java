 ...
 * @author Azough Mehdi
 */
public class Modifier1 extends javax.swing.JFrame {
    
    /**
     * Creates new form Ajouter_Modifier_Util
     */
    private MonCompteDept monCompteDept;
    private AcceuilAdminDept ad;
    String iduser;
    
    public void setGererUtili(MonCompteDept mcd){
        this.monCompteDept = mcd;
    }
    
    
    public void setIDUserMod1(String id){
        this.iduser = id;
...
//            JOptionPane.showMessageDialog(null,"Enseignant modifié avec succès");
            this.monCompteDept.setAdminDept(ens);
            this.dispose();
...
//            java.util.logging.Logger.getLogger(Modifier1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

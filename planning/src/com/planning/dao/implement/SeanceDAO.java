...
public class SeanceDAO extends DAO<Seance> {
    ...
    public boolean create(Seance obj) {
            ...
            query = "INSERT INTO APP.Seance VALUES (DEFAULT, ";
            ...
            System.out.println("SQLException in SeanceDAO.create: " + e);
            return false;
        }
    ...
    public boolean delete(Seance obj){
        try {
            this.conn.createStatement().executeUpdate("DELETE FROM APP.Seance WHERE NumSeance = " + obj.getNumSeance());
        } 
        catch (SQLException e) {
            System.out.println("SQLException in SeanceDAO.delete: " + e);
            return false;
        }
        return true;
    }
    ...
    public boolean update(Seance obj){
        try {
            ...
            query = "UPDATE APP.Seance SET NumCreneau = " + obj.getNumCreneau()+ ",  NumEns = " + obj.getNumEns()+ ", NumMatiere = ";
            ...
            System.out.println("SQLException in SeanceDAO.update: " + e);
            return false;
	}
        return true;
    }
    ...
    public Seance find(int numseance){
        ...
        try {
            state = conn.createStatement();
            query = "SELECT * FROM APP.Seance WHERE NumSeance = " + numseance;
            res = state.executeQuery(query);
            while(res.next()) {
                seance = new Seance(res.getInt(1), res.getInt(2), res.getInt(3), res.getInt(4), res.getInt(5), res.getInt(6));                
            }
        } catch (SQLException e) {
            System.out.println("SQLException in SeanceDAO.find: " + e);
    ...
    public Set<Seance> findByNumEns(int nume){
        ...
        try {
            state = conn.createStatement();
            query = "SELECT * FROM APP.Seance WHERE NumEns = " + nume + " AND EtatSeance = 1 ORDER BY NumCreneau";
            res = state.executeQuery(query);
            while(res.next()) {
            ...
            System.out.println("SQLException in SeanceDAO.findByNumEns: " + e);
        }
        return seanceList;
    }
    ...
    public Set<Seance> findByNumGroupe(int numg){
        ...
        try {
            state = conn.createStatement();
            query = "SELECT * FROM APP.Seance WHERE NumGroupe = " + numg;
            res = state.executeQuery(query);
            while(res.next()) {
                Seance seance = new Seance(res.getInt("NumSeance"),res.getInt("NumCreneau"), res.getInt("NumEns"), res.getInt("NumMatiere"), res.getInt("NumGroupe"),res.getInt("EtatSeance"));
                seanceList.add(seance);                  
    ...
    public Set<Seance> findByNumMatiere(int numm){
        ...
        try {
            state = conn.createStatement();
            query = "SELECT * FROM APP.Seance WHERE NumMatiere = " + numm;
            res = state.executeQuery(query);
            while(res.next()) {
                Seance seance = new Seance(res.getInt("NumSeance"),res.getInt("NumCreneau"), res.getInt("NumEns"), res.getInt("NumMatiere"), res.getInt("NumGroupe"),res.getInt("EtatSeance"));
                seanceList.add(seance);                  
    ...
    public Seance getSeanceByFields(int numCreneau, int numEns, int numGroupe, int EtatSeance) {
        Seance s = null;
        try{
            query = "SELECT * FROM APP.Seance WHERE NumCreneau = " + numCreneau + " AND NumEns = " + numEns + " AND NumGroupe = " + numGroupe;
            ...
            System.out.println("SQLException in SeanceDAO.getSeanceByField: " + ex);
        }
        return s;
    }
    ...
    public void createAllSeance(StatiqueCreneau sc) {
        ...
        try {
            ...
            String req2 = "Select NumCreneau , Date FROM APP.Creneau WHERE Date >= '" + dateD + "' and Date <= '" + dateF + "' and Heure = '" + t + "'";
            ...
            System.out.println("SQLException in SeanceDAO.createALLSeance:" + e);
        }
